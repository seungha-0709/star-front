<template>
  <div class="join-verification-page">
    ...
    <div class="banner">
      <img src="/img/banner/invalid-name@3x.png" alt="배너이미지" />
    </div>
    <div class="button">
      <basic-button
        class="back-button"
...
<script>
  ...
  import joinVerification from "../../../components/join/joinVerification.vue"
