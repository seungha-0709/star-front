        ...
        <tr class="title-amount outer-border">
          <td class="content-amount quantity">
            <div class="inner-border">
              <div>
                상품금액
                <div class="content-title">{{ `${(80000).toLocaleString()}원` }}</div>
              </div>
            </div>
          </td>
          <td class="content-amount origin-price">
            <div class="inner-border">
              <div>
                ...
                <div class="content-title">{{ `${(8000).toLocaleString()}원` }}</div>
              </div>
            </div>
          </td>
          <td class="content-amount discount">
            <div class="inner-border">
              <div>
                ...
                <div class="content-title discount-price">{{ `${(0).toLocaleString()}원` }}</div>
              </div>
            </div>
          </td>
          <td class="content-amount shipping">
            <div>
              ...
              <div class="content-title">{{ `${(72000).toLocaleString()}원` }}</div>
            </div>
          </td>
        </tr>
      </tbody>
