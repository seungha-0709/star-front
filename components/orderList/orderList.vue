    ...
    <table>
      <tbody>
        <tr class="tr-main">
          ...
          <td class="price">{{ `${orderListData[idxData].paymentPrice.toLocaleString()}원` }}</td>
          <td class="status">
        ...
        <tr class="tr-bottom">
            ...
            <div class="bottom-left-wrap">
              <div class="btn-order-position">
                <basic-button
                  ...
                  width="97"
                  height="28"
                  @event="onModalOnOff('order')"
                ></basic-button>
              </div>
              <modal :modalProps="modalInfoOrder" v-if="modalOrderOpen === true">
              ...
              <div class="btn-receipt-position">
                <basic-button
                  ...
                  width="113"
                  height="28"
                  @event="onModalOnOff('receipt')"
                ></basic-button>
              </div>
              <modal :modalProps="modalInfoReceipt" v-if="modalReceiptOpen === true">
          ...
          <td class="bottom-right">
            <basic-button
              ...
              width="102"
              height="28"
              @event="onModalOnOff('cancel')"
              v-if="
                orderListData[idxData].cancel === false &&
                orderListData[idxData].refund === false
              "
            ></basic-button>
            <modal :modalProps="modalInfoCancel" v-if="modalCancelOpen === true">
            ...
            <basic-button
              ...
              width="102"
              height="28"
              @event="onModalOnOff('qna')"
              v-if="
                orderListData[idxData].cancel === true ||
                orderListData[idxData].refund === true
              "
            ></basic-button>
            <modal :modalProps="modalInfoQna" v-if="modalQnaOpen === true">
