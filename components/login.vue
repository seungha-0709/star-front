  ...
  <div class="login-wrap">
    <div class="login-body">
      <div class="login-left">
        <img src="../static/img/login/login_logo_h_white.png" alt="별별선생" class="top-logo" />
        <div class="login-left-wrap">
          <img src="../static/img/login/group-6.png" alt="별별선생은 우리 모두의 공간입니다." />
          <span>
            <basic-button
              text="자세히 보기"
      ...
      <div class="login-right">
        ...
        <div class="login-main">
          ...
          <div class="login-sns">
            <span class="login-sns-naver"></span>
            <span class="login-sns-kakao"></span>
            <span class="login-sns-facebook"></span>
          </div>
          ...
          <div class="btn_position">
            <basic-button text="로그인" width="240" backgroundColor="#3f60cc" />
          </div>
        ...
        <div class="login-footer">
          <span class="login-copyright">Copyright © TEvalueWise Corp. All Rights Reserved.</span>
        </div>
      </div>
    </div>
  </div>
...
/** 좌측 이미지 배너 **************************************/
.login-left {
  background-image: url(../static/img/login/tip-103-s-15100186.png);
...
.login-input-wrap > span:nth-of-type(2) {
  margin-top: 32px;
}
.btn_position {
  margin-top: 50px;
